...
public interface Componentable {
    ...
    String getInputAttributes();
    
    String getOutputAttributes();
    
    void setAttributeValue(String myinput,String value);
    
    String getState();
    
    void setState(String mystate, int value);
    
    String getAttributeValue(String myinput);
